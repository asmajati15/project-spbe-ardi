                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            ...
                            <i
                                class="fas fa-newspaper fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">213</h3>
                                <p class="fs-5">Pengunjung</p>
                            </div>
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Main PB Full Cash 100% No Root</td>
                                    <td>19/02/2024 12:45</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
